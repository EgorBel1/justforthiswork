  		...
  		<div id="hot-deal" class="section mainn mainn-raised">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							<a class="primary-btn cta-btn" href="store.php">Каталог</a>
						</div>
					</div> 
				</div>
				<!-- /row -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								...
								<a href="product.php?p=<?php echo $prod['product_id'] ?>" class="cta-btn">Новинки<i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
