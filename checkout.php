	...
	<div class="container-fluid">
			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<input type="text" id="fname" class="form-control" name="firstname" pattern="/^[a-zA-Zа-яА-Я ]+$/u"  value="'.$row["first_name"].' '.$row["last_name"].'">
		...
		?>
			...
			<div class="col-25">
				...
				<h3>Итого<span class='price' style='color:black'><b>$total</b>р</span></h3>";
