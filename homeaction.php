                       ...
                       <div class='product-widget'>
                                <a href='product.php?p=$pro_id'> 
									...
									<div class='product-body'>
										...
										<h4 class='product-price'>$pro_price<del class='product-old-price'>990.00 р</del></h4>
									</div></a>
								</div>
			...
			echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>990.00 р</del></h4>
										...
										<div class='product-btns'>
											<button class='add-to-wishlist'><i class='fa fa-heart-o'></i><span class='tooltipp'>добавить в избранное</span></button>
											<button class='add-to-compare'><i class='fa fa-exchange'></i><span class='tooltipp'>добавить к сравнению</span></button>
