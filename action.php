                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price р</h4>
									</div>
                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										<p class='product-category'>$cat_name</p>
										<h3 class='product-name header-cart-item-name'><a href='product.php?p=$pro_id'>$pro_title</a></h3>
										<h4 class='product-price header-cart-item-info'>$pro_priceheck р</h4>
									</div>
									<div class='add-to-cart'>
		...
		if($count > 0){
			echo "
				<div class='alert alert-warning'>
						...
						<b>Товар уже добавлен в корзину!</b>
				</div>
			";//not in video
		} else {
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">'.$n.'</span>'.$product_price.'р</h4>
												</div>
            ...
            echo '<div class="cart-summary">
				    <small class="qty">'.$n.' Выбранный предмет(ы)</small>
				    <h5>$'.$total_price.'</h5>
				</div>'
            ?>
		...
		if (mysqli_num_rows($query) > 0) {
			...
			<form method="post" action="login_form.php">
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					echo 
						...
						<tr>
							...
							<td data-th="Итого" class="text-center"><input type="text" class="form-control total" value="'.$product_price.'" readonly="readonly"></td>
				...
				<tfoot>
					...
					<tr>
						<td><a href="store.php" class="btn btn-info"><i class="fa fa-angle-left"></i> Назад</a></td>
				...
				if (!isset($_SESSION["uid"])) {
					echo '
							...
							<a href="" data-toggle="modal" data-target="#Modal_register" class="btn btn-primary">Оформить</a></td>
								</tr>
							</tfoot>
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="egor@mail.ru">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/myfiles/public_html/payment_success.php"/>
									...
									<input type="hidden" name="currency_code" value="Руб"/>
									<input type="hidden" name="custom" value="'.$_SESSION["uid"].'"/>
									<input type="submit" id="submit" name="login_user_with_product" name="submit" class="btn btn-primary" value="Оформить заказ">
									</form></td>
